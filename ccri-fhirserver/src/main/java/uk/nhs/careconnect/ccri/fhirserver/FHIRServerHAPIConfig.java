...
public class FHIRServerHAPIConfig extends RestfulServer {

    private static final long serialVersionUID = 1L;
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(FHIRServerHAPIConfig.class);

  

    private ApplicationContext applicationContext;

    FHIRServerHAPIConfig(ApplicationContext context) {
    ...
    protected void initialize() throws ServletException {
        ...
        for (String permission : permissions) {
            try {
                classType = Class.forName("uk.nhs.careconnect.ccri.fhirserver.provider." + permission + "Provider");
        ...
        if (validate) {
            ...
            CCRequestValidatingInterceptor requestInterceptor = new CCRequestValidatingInterceptor(log, (FhirValidator) applicationContext.getBean("fhirValidator"));
