...
public class PatientProvider implements ICCResourceProvider {
    ...
    public List<Resource> searchPatient(HttpServletRequest theRequest,
           ...
           @OptionalParam(name= Patient.SP_PHONE) StringParam phone
            ...
            ,@IncludeParam(reverse=true, allow = {"AllergyIntolerance:patient","Condition:patient","Immunization:patient","MedicationStatement:patient",
            "Observation:patient","Procedure:patient","Encounter:patient","DocumentReference:patient","*"}) Set<Include> reverseIncludes
            ,@IncludeParam(allow= {
