...
public class SNOMEDUKDbValidationSupportR4 implements IValidationSupport {
  ...
  private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SNOMEDUKDbValidationSupportR4.class);
  ...
  public SNOMEDUKDbValidationSupportR4(final FhirContext r4Ctx, FhirContext stu3Ctx) {
    this.ctxR4 = r4Ctx;
    ...
    log.info(this.terminologyServer);
    try {
    client = ctxStu3.newRestfulGenericClient(terminologyServer);
  } catch (Exception ex){
