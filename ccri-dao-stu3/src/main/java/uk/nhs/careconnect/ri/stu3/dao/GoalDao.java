...
import uk.nhs.careconnect.ri.stu3.dao.transforms.GoalEntityToFHIRGoalTransformer;
...
public class GoalDao implements GoalRepository {
    ...
    public List<GoalEntity> searchEntity(FhirContext ctx, ReferenceParam patient, TokenParam identifier, StringParam resid) {
        ...
        TypedQuery<GoalEntity> typedQuery = em.createQuery(criteria).setMaxResults(daoutils.MAXROWS);
