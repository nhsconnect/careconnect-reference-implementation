...
import uk.nhs.careconnect.ri.daointerface.transforms.CompositionEntityToFHIRCompositionTransformer;
...
public class CompositionDao implements CompositionRepository {
    ...
    @Override
    public Composition create(FhirContext ctx, Composition composition, IdType theId, String theConditional) {
    ...
    public List<CompositionEntity> searchEntity(FhirContext ctx, ReferenceParam patient, TokenParam identifier, TokenParam id) {
        ...
        TypedQuery<CompositionEntity> typedQuery = em.createQuery(criteria).setMaxResults(MAXROWS);
