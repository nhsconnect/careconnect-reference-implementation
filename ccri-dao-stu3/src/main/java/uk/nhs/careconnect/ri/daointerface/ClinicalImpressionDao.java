...
import uk.nhs.careconnect.ri.daointerface.transforms.ClinicalImpressionEntityToFHIRClinicalImpressionTransformer;
...
import uk.nhs.careconnect.ri.entity.clinicialImpression.ClinicalImpressionFinding;
import uk.nhs.careconnect.ri.entity.clinicialImpression.ClinicalImpressionIdentifier;
...
public class ClinicalImpressionDao implements ClinicalImpressionRepository {
    ...
    public List<ClinicalImpressionEntity> searchEntity(FhirContext ctx, ReferenceParam patient, TokenParam identifier, TokenParam resid) {
        ...
        TypedQuery<ClinicalImpressionEntity> typedQuery = em.createQuery(criteria).setMaxResults(MAXROWS);
