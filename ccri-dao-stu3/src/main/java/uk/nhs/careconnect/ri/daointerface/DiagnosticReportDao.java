...
public class DiagnosticReportDao implements DiagnosticReportRepository {
    ...
    @Override
    public List<DiagnosticReportEntity> searchEntity(FhirContext ctx, ReferenceParam patient, TokenParam identifier, TokenParam id) {
        ...
        TypedQuery<DiagnosticReportEntity> typedQuery = em.createQuery(criteria).setMaxResults(MAXROWS);
