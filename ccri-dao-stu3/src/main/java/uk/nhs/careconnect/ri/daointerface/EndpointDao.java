...
import uk.nhs.careconnect.ri.daointerface.transforms.EndpointEntityToFHIREndpointTransform;
import uk.nhs.careconnect.ri.entity.Terminology.ConceptEntity;
import uk.nhs.careconnect.ri.entity.endpoint.EndpointEntity;
import uk.nhs.careconnect.ri.entity.endpoint.EndpointIdentifier;
...
public class EndpointDao implements EndpointRepository {
    ...
    public List<EndpointEntity> searchEndpointEntity(FhirContext ctx, TokenParam identifier, TokenParam resid) {
        ...
        TypedQuery<EndpointEntity> typedQuery = em.createQuery(criteria).setMaxResults(MAXROWS);
