...
import uk.nhs.careconnect.ri.daointerface.transforms.RiskAssessmentEntityToFHIRRiskAssessmentTransformer;
import uk.nhs.careconnect.ri.entity.Terminology.ConceptEntity;
import uk.nhs.careconnect.ri.entity.condition.ConditionEntity;
import uk.nhs.careconnect.ri.entity.encounter.EncounterEntity;
import uk.nhs.careconnect.ri.entity.patient.PatientEntity;
import uk.nhs.careconnect.ri.entity.riskAssessment.RiskAssessmentEntity;
import uk.nhs.careconnect.ri.entity.riskAssessment.RiskAssessmentIdentifier;
import uk.nhs.careconnect.ri.entity.riskAssessment.RiskAssessmentPrediction;
...
public class RiskAssessmentDao implements RiskAssessmentRepository {
    ...
    public List<RiskAssessmentEntity> searchEntity(FhirContext ctx, ReferenceParam patient, TokenParam identifier, TokenParam resid) {
        ...
        TypedQuery<RiskAssessmentEntity> typedQuery = em.createQuery(criteria).setMaxResults(MAXROWS);
