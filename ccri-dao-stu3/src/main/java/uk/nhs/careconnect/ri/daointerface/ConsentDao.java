...
import uk.nhs.careconnect.ri.daointerface.transforms.ConsentEntityToFHIRConsentTransformer;
import uk.nhs.careconnect.ri.entity.Terminology.ConceptEntity;
import uk.nhs.careconnect.ri.entity.careTeam.CareTeamEntity;
import uk.nhs.careconnect.ri.entity.consent.*;
...
public class ConsentDao implements ConsentRepository {
    ...
    public List<ConsentEntity> searchEntity(FhirContext ctx, ReferenceParam patient, TokenParam identifier, TokenParam resid) {
        ...
        TypedQuery<ConsentEntity> typedQuery = em.createQuery(criteria).setMaxResults(MAXROWS);
