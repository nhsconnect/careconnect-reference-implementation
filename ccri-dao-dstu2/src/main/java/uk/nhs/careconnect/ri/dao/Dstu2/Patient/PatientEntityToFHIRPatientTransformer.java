package uk.nhs.careconnect.ri.dao.Dstu2.Patient;
    ...
    public Patient transform(final PatientEntity patientEntity) {
        ...
        for (PatientName nameEntity : patientEntity.getNames()) {
            ...
            if (nameEntity.getNameUse() != null) {
                name.setUse(nameEntity.getNameUseDstu2());
            }
        }
        ...
        for(int f=0;f<patientEntity.getAddresses().size();f++)
        {
            ...
            if (patientEntity.getAddresses().get(f).getAddressType() != null) {
                adr.setType(patientEntity.getAddresses().get(f).getAddressTypeDstu2());
            }
            if (patientEntity.getAddresses().get(f).getAddressUse() != null) {
                adr.setUse(patientEntity.getAddresses().get(f).getAddressUseDstu2());
            }
        ...
        {
            patient.addTelecom()
                    .setSystem(patientEntity.getTelecoms().get(f).getSystemDstu2())
                    .setValue(patientEntity.getTelecoms().get(f).getValue())
                    .setUse(patientEntity.getTelecoms().get(f).getTelecomUseDstu2());
        }
