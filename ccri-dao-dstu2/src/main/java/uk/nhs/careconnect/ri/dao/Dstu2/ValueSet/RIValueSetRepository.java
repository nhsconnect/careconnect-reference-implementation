            ...
            for (ValueSet.ConceptSetComponent component :valueSet.getCompose().getInclude()) {
                ...
                for (ValueSet.ConceptSetFilterComponent filter : component.getFilter()) {
                    ...
                    if (filterEntity == null) {
                        ...
                        // disabled for stu3 filterEntity.setValue(codeSystemRepository.findAddCode(codeSystemEntity,concept));
                        // disabled for stu3 filterEntity.setOperator(filter.getOp());
                ...
                for (ValueSet.ConceptReferenceComponent conceptReferenceComponent : component.getConcept()) {
                    ...
                    if (includeConcept == null) {
                        ...
                        // disabled for stu3  includeConcept.setConcept(codeSystemRepository.findAddCode(codeSystemEntity,concept));
