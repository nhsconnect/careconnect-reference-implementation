...
public class EncounterEntity extends BaseResource {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name="SERVICE_TYPE_ID",foreignKey= @ForeignKey(name="FK_ENCOUNTER_SERVICE_TYPE_ID"))
    private ConceptEntity serviceType;
    ...
    public EncounterEntity setServiceType(ConceptEntity serviceType) {
